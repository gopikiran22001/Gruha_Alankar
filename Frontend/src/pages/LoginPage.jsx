...
export const LoginPage = () => {
  ...
  const { login, loginWithGoogle, isLoading, error, isFirebaseActive } = useAuthStore();
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 bg-background relative select-none">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-xl shadow-premium border border-border relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute -left-10 -top-10 w-28 h-28 bg-primary/10 rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="flex flex-col items-center space-y-2 mb-6">
          ...
          <p className="text-xs text-muted">Sign in to your design workspace</p>
        </div>
        ...
        {!isFirebaseActive && (
          <div className="p-3 bg-zinc-950/40 border border-primary/20 rounded-lg text-[10px] text-primary/80 mb-5 relative overflow-hidden flex flex-col gap-1">
            ...
            <p className="text-zinc-400 font-medium leading-relaxed">
              Using Flask/JWT authentication. Register or sign in with email and password.
            </p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex flex-col space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <a href="#forgot" className="text-[10px] font-semibold text-primary hover:underline">Forgot password?</a>
            </div>
            <div className="relative">
              <input
                type="password"
